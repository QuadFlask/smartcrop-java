...
public class SmartCrop {
    ...
    public CropResult analyze(BufferedImage input) {
        ...
        BufferedImage score = new BufferedImage(input.getWidth() / options.getScoreDownSample(), input.getHeight() / options.getScoreDownSample(), BufferedImage.TYPE_INT_ARGB);
    ...
    private BufferedImage createScaleDown(BufferedImage image, float ratio) {
        BufferedImage scaled = new BufferedImage((int) (ratio * image.getWidth()), (int) (ratio * image.getHeight()), BufferedImage.TYPE_INT_ARGB);
